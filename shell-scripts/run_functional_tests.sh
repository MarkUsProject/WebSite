...
# run functional tests for mark2
...
export RAILS_ENV
RUBY="/usr/bin/ruby"
LOGFILE="log/functional_tests_report.log"
LOGFILE2="log/functional_tests_report_single.log"
LOGFILE3="log/functional_tests_report_update.log"
